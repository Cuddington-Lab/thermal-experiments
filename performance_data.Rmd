...
### This document provides information for modelling the performance 
### distribution of organisms in strongly autocorrelated temperature scenarios
...
### Create new column including RGR and remove negative RGR values
```{r}
