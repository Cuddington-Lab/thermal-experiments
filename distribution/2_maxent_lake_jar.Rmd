...
e_2europe_sure = evaluate(pres_test_sure, backg_test, model1, lake)
...
```{r}
pred.seq.lake <- eval.predictions(e.mx.l.lake)[[res_best$tune.args]]

writeRaster(pred.seq.lake, filename="pred.seq.lake",  format="GTiff", overwrite=TRUE)
```
