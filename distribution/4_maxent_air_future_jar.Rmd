...
e_2europe_sure = evaluate(pres_test_sure, backg_test, model1, air_future)
...
# test data TSS when using best training threshold
threshold_test_train <- e_2test@t[which(e_2test@TPR+e_2test@TNR==threshold_train)]
threshold_test_train
```


### Save model predictions
```{r}
pred.seq.air.future <- eval.predictions(e.mx.l.air.future)[[res_best$tune.args]]

writeRaster(pred.seq.air.future, filename="predseqairfuture",  format="GTiff", overwrite=TRUE)
```