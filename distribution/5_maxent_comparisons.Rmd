...
### Load bioclimatic variables and sampled datasets obtained in previous steps of the analysis
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
plot(pred.seq.lake, xlim=c(-20,31.5500), ylim=c(34.5000,71.0500), xlab = "Longitude", ylab= "Latitude",cex.lab=1.5)
  legend("topleft", legend=c("Exact occurrences", "Approximate occurrences", "Common duckweed distribution"), 
        col=c("black", "#D55E00", "#0072B2"), pch = c(20,20,NA), lty = c(NA,NA,1), cex = 0.9, lwd=2)
