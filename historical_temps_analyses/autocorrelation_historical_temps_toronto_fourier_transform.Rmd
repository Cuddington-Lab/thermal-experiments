...
hist <- read.csv("https://raw.githubusercontent.com/Cuddington-Lab/thermal-experiments/historical_temps_analyses/historical_temps_toronto.csv", header=TRUE, stringsAsFactors = TRUE)
```
