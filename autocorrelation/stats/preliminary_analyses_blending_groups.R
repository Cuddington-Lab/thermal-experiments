## make this into .rmd
## justify that 10-15, lab_lm & field_lm, and 2 prep methods
## were blended because there's no significant difference between them
## justify that at 27C, there appears to be some differences in
## performance between prep or strain, so these were eliminated from
## analysis (only 6 replicates in the 27C average treatment group)
