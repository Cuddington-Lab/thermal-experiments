...
title1 = expression(paste("no autocorrelation (", alpha,"=0)"))
title2 = expression(paste("from cold to hot"))
title3 = expression(paste("from hot to cold"))

par(mfrow = c(1, 3))
plot(tseq[,1],type="l",col="grey37",lwd=2,main=title1,cex.lab = 2.3,
     cex.axis = 2.3,cex.main = 3,xlab="",ylab="",col.main="black")
abline(h=27,col="black",lwd=2.3)
plot(tseq[,3], type="l", col="#0072B2",lwd=2,main=title2,cex.lab = 2.3,
     cex.axis = 2,cex.main = 3,ylab="",col.main="#0072B2",xlab="Temperature (°C)")
abline(h=27,col="black",lwd=2.3)
plot(tseq[,4], type="l", col="#D55E00",lwd=2,main=title3, cex.lab = 2.3,
     cex.axis = 2.3,cex.main = 3,ylab="",xlab="",col.main="#D55E00")
abline(h=27,col="black",lwd=2.3)
